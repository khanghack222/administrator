#!/usr/bin/env node
/**
 * 1 lượt reg Grok — reuse latest mail, proxy, NopeCHA
...
import { ensureExtension, resolveNopechaKey, EXT_DIR } from "./nopecha.mjs";
...
async function main() {
  ...
  const path = ensureExtension(resolveNopechaKey(null));
  try {
